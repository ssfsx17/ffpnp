...
- **Support: Dual-Wield:** You can equip two 1H weapons. Your regular Attack actions perform a separate attack with each one. Other actions based on weapons use whichever weapon will have better results.
